...
const HEADERS = [
  'session_id', 'fecha_inicio', 'nombre', 'whatsapp', 'perfil',
  'paso', 'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8',
  'resultado_visto', 'abandono_en', 'ultimo_update',
]

async function main() {
  const spreadsheetId = process.argv[2]
  if (!spreadsheetId) {
    console.error('Uso: npx tsx scripts/crear-sheet-funnel.ts <GOOGLE_SHEETS_ID>')

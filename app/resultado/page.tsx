    ...
    <DesktopLayout leftContent={
      ...
      <div className="min-h-[100dvh]">
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:px-16 lg:py-20">
          ...
          {nombre && (
            <p className="text-lg text-mc-gris leading-relaxed mb-6">
              {p.saludo.replace('[nombre]', nombre)}
            </p>
          )}
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1fba58] text-white font-bold py-4 px-8 rounded-sm text-sm tracking-widest uppercase transition-colors duration-200 mb-6"
          >
